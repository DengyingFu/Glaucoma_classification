...
img_path = "D:\Glaucoma-System\Dataset\ACRIMA原始数据集\ACRIMA划分\\val\Glaucoma\Im700_g_ACRIMA.jpg"

assert os.path.exists(img_path), "file: '{}' dose not exist.".format(img_path)
img = Image.open(img_path)
img_init = normalize(img, mean, std)
# [N, C, H, W]
...
# load model weights
weights_path = "D:\Glaucoma-System\暑假工作\主动学习\训练结果\\best_['bald'].pth"
...
targets = [ClassifierOutputTarget(1)]
target_layers = [model_grad.features[23]] #vgg16 是23
# target_layers = [model_grad.features[6]]  #Alexnet 是6
